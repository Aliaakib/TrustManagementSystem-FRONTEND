...
//         setStats(res.data);
//       } catch (err) {
//         console.error("Error fetching member dashboard stats:", err);
//       }
//     };
...
const MemberDash = () => {
  ...
  useEffect(() => {
    const trustId = localStorage.getItem("trustId");
    if (!trustId || trustId === "null") {
      console.warn("No valid trustId in localStorage");
      return;
    }
