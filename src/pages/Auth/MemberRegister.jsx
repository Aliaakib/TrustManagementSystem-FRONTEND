  ...
  return (
    <div className="register1-container">
      <section className="register1-card">
        <h2 className="register1-title">Member Registration</h2>
        <p className="register1-subtitle">Join the Trust as a Member</p>
        <form className="register1-form" onSubmit={handleSubmit}>
          ...
          <div className="register1-input-group">
            ...
            <input
              type="text"
              name="trustId"
              placeholder="Enter Trust ID (provided by admin)"
              required
