...
//           <FaSearch className="donation-search-icon" />
//         </div>
...
//                   <td>{d.phone}</td>
//                   <td>
//                     <span className={`badge-mode ${d.mode}`}>{d.mode}</span>
//                   </td>
...
//         <div className="donation-mobile-cards">
//           {donations.length > 0 ? (
//             donations.map((d, i) => (
//               <div key={d._id} className="donation-card">
//                 <p>
//                   <strong>Sr No:</strong> {i + 1}
//                 </p>
//                 <p>
...
//             ))
//           ) : (
//             <div className="no-donation-mobile">No donations available.</div>
//           )}
//         </div>
...
//           <div className="summary-card">
//             <span>Online</span>
//             <strong>₹{totalOnline.toFixed(2)}</strong>
//           </div>
//           <div className="summary-card">
//             <span>Cheque</span>
//             <strong>₹{totalCheque.toFixed(2)}</strong>
//           </div>
//         </div>
//       </div>
